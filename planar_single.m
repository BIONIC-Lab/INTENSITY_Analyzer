...
if part==1
    ...
    y2=[y-d2 y+d2];
    %%% plot probe track
    plot([x+d1w x+d1w],[y-d1h/2 y+d1h/2],'r'); hold on;
    plot([x-d1w x-d1w],[y-d1h/2 y+d1h/2],'r');
    plot([x-d1w x+d1w],[y+d1h/2 y+d1h/2],'r');
    plot([x-d1w x+d1w],[y-d1h/2 y-d1h/2],'r');
  ...
  if bindir==1
      ...
      plot([x2(1)-d1w/2 x2(2)+d1w/2],[y-d1h/2 y-d1h/2],'r'); hold on;
      plot([x-d1w/2 x+d1w/2],[y2(1)-d1h/2 y2(1)-d1h/2],'r');
  elseif bindir==2
      plot([x2(1)-d1w/2 x2(2)+d1w/2],[y+d1h/2 y+d1h/2],'r'); hold on;
      plot([x-d1w/2 x+d1w/2],[y2(2)+d1h/2 y2(2)+d1h/2],'r');
  elseif bindir==3
     plot([x-d1w/2 x-d1w/2],[y2(1)-d1h/2 y2(2)+d1h/2],'r'); hold on;
